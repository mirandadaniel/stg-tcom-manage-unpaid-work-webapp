...
export const getUserDetails = async (userId: string): Promise<UserDetails> => popService.getUserDetails(userId)
...
export const getAppointments = async (userId: string): Promise<AppointmentLists> => popService.getAppointments(userId)
...
export const getUnpaidWorkWarning = async (userId: string): Promise<string> => popService.getUnpaidWorkWarning(userId)

export const getUnpaidWorkConditions = async (userId: string) => popService.getUnpaidWorkConditions(userId)

export const getProbationConditions = async (userId: string) => popService.getProbationConditions(userId)
