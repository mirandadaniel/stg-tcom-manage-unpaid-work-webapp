...
export default function CheckPhoneLogin({
  searchParams,
}: {
  ...
  return (
    <>
      ...
      <a href="/one-login/enter-password" className="govuk-back-link">
        Back
      </a>
      <div className="govuk-grid-row">
        <div className="govuk-grid-column-two-thirds">
          <form className="form" action="/one-login/check-phone-login/submit" method="post">
